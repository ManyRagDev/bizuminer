...
4. Ativar o workflow preparado após o piloto: Shopee e AliExpress quatro vezes ao dia com orçamento inicial de 20 itens por loja por rodada, isolamento de concorrência e segredos no executor. Configurar `MONITORING_ENABLED=true` após publicar o workflow. Subir o orçamento com dados de rate limit e cobertura; o teto do CLI é 100 por rodada. Não agendar scraping do ML.
